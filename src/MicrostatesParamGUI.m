...
cb_RS=  uicheckbox(restingState_panel,'Position',[210 110 20 20],'Value',false,'Text','','FontSize',fontsize,'FontColor',foregroundColor,'ValueChangedFcn',@(cbx,event)Enable_RS(cbx));
...
ef_RSEC = uieditfield(RStrigger_panel,'Value',default.preproc.EClabel,'Position',[105 15 60 20],'HorizontalAlignment','left','BackgroundColor', backgroundColor,'FontSize',fontsize,'FontColor',foregroundColor,'Enable',false);
...
ef_RSEO = uieditfield(RStrigger_panel,'Value',default.preproc.EOlabel,'Position',[265 15 60 20],'HorizontalAlignment','left','BackgroundColor', backgroundColor,'FontSize',fontsize,'FontColor',foregroundColor,'Enable',false);
...
ef_RSLatencystart = uieditfield(restingState_panel,'numeric','Value',default.preproc.timelimits(1),'Position',[210 10 30 20],'HorizontalAlignment','left','BackgroundColor', backgroundColor,'FontSize',fontsize,'FontColor',foregroundColor,'Enable',false);
ef_RSLatencyend = uieditfield(restingState_panel,'numeric','Value',default.preproc.timelimits(2),'Position',[250 10 30 20],'HorizontalAlignment','left','BackgroundColor', backgroundColor,'FontSize',fontsize,'FontColor',foregroundColor,'Enable',false);
...
cb_gfpaverageRef = uicheckbox(gfp_panel,'Position',[210 135 20 20],'Value',default.microstate.gfp.avgref,'Text','','FontSize',fontsize,'FontColor',foregroundColor);
...
dd_algorithm = uidropdown(clustering_panel,'Items', {'modkmeans','kmeans','taahc','aahc','varmicro'},'Value',default.microstate.algorithm,'Position',[210 240 130 20],'BackgroundColor', backgroundColor,'FontSize',fontsize,'FontColor',foregroundColor);
...
dd_sorting = uidropdown(clustering_panel,'Items', {'Global explained variance', 'Chronological appearance','Frequency'},'Value',default.microstate.sorting,'Position',[210 215 130 20],'BackgroundColor', backgroundColor,'FontSize',fontsize,'FontColor',foregroundColor);
...
ef_nbRepFirst = uieditfield(repetition_panel,'numeric','Value',default.microstate.Nrepfirstlevel,'Position',[105 15 50 20],'HorizontalAlignment','left','BackgroundColor', backgroundColor,'FontSize',fontsize,'FontColor',foregroundColor);
...
ef_nbRepOther = uieditfield(repetition_panel,'numeric','Value',default.microstate.Nrepotherlevel,'Position',[265 15 50 20],'HorizontalAlignment','left','BackgroundColor', backgroundColor,'FontSize',fontsize,'FontColor',foregroundColor);
...
cb_polarity = uicheckbox(clustering_panel,'Position',[210 10 20 20],'Value',default.microstate.orderingpolarity,'Text','','FontSize',fontsize,'FontColor',foregroundColor);
